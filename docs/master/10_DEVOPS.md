...
└── Base de datos: 192.168.1.43:5432
```

### Credenciales de Base de Datos
```properties
spring.datasource.url=jdbc:postgresql://192.168.1.43:5432/conteo_electoral
...
export const environment = {
  production: true,
  apiUrl: 'http://192.168.1.43:8081/api',
  wsUrl: 'http://192.168.1.43:8081/ws',
...
```bash
# Backup
pg_dump -h 192.168.1.43 -U postgres conteo_electoral > backup_$(date +%Y%m%d).sql

# Restore
psql -h 192.168.1.43 -U postgres conteo_electoral < backup.sql

# Conectar
psql -h 192.168.1.43 -U postgres -d conteo_electoral
```
