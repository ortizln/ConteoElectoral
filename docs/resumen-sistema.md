...
Base de datos **PostgreSQL 18** en servidor `192.168.1.43:5432`, con réplica local **SQLite** en la app móvil para operación offline.
...
### 5.1 Esquema PostgreSQL (servidor: 192.168.1.43)
```
...
- **Web** (prod): `http://192.168.1.43:8081/api`
