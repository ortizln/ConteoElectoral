  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        <h1>Gestion de Recintos</h1>
        <button class="btn btn-primary btn-sm" (click)="openModal()">+ Nuevo</button>
      </div>
      <div class="card">
        <table class="table table-hover table-sm">
          <thead><tr><th>Nombre</th><th>Direccion</th><th>Total Mesas</th><th class="text-center">Acciones</th></tr></thead>
          <tbody>
            <tr *ngFor="let r of recintos">
              ...
              <td class="text-center">
                <button class="btn btn-outline-primary btn-sm me-1" (click)="edit(r)">Editar</button>
                <button class="btn btn-outline-danger btn-sm" (click)="delete(r.id)">Eliminar</button>
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div class="modal-overlay" *ngIf="showModal">
        <div class="modal-content">
          <div class="modal-header">
            <h3>{{ editMode ? 'Editar' : 'Nuevo' }} Recinto</h3>
          ...
          <div class="modal-body">
            ...
            <div class="form-group"><label>Direccion</label><input type="text" class="form-control" [(ngModel)]="form.direccion"></div>
