  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        <h1>Gestión de Cargos Electorales</h1>
        <button class="btn btn-primary" (click)="openModal()">+ Nuevo Cargo</button>
      </div>
      <div class="card">
      ...
      <div class="modal-overlay" *ngIf="showModal">
        <div class="modal-content">
          <div class="modal-header"><h3>Nuevo Cargo</h3><button class="btn-close" (click)="closeModal()">×</button></div>
          <div class="modal-body">
            <div class="form-group">
              <label>Nombre</label><input type="text" class="form-control" [(ngModel)]="form.nombre">
            </div>
            <div class="form-group">
              <label>Descripción</label><input type="text" class="form-control" [(ngModel)]="form.descripcion">
            </div>
            <div class="form-group">
