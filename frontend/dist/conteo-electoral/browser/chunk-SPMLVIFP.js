...
var ApiService = class _ApiService {
  ...
  actualizarListaElectoral(id, data) {
    return this.http.put(`${this.API_URL}/listas-electorales/${id}`, data);
  }
  // Plantillas Papeleta
  ...
  getReporteListas(eleccionId) {
    return this.http.get(`${this.API_URL}/reportes/${eleccionId}/listas`);
  }
