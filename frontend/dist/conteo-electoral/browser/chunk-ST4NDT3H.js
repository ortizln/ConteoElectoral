...
function MesaVotacionComponent_div_13_ng_container_40_tr_1_div_11_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("Lista #", l_r7.numeroLista, "");
  }
}
function MesaVotacionComponent_div_13_ng_container_40_tr_1_button_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 80);
    \u0275\u0275listener("click", function MesaVotacionComponent_div_13_ng_container_40_tr_1_button_18_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const l_r7 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.abrirListaModal(l_r7));
    });
    \u0275\u0275text(1, " Ver ");
    \u0275\u0275elementEnd();
  }
}
function MesaVotacionComponent_div_13_ng_container_40_tr_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275template(11, MesaVotacionComponent_div_13_ng_container_40_tr_1_div_11_Template, 2, 1, "div", 75);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "td")(13, "span", 76);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275template(18, MesaVotacionComponent_div_13_ng_container_40_tr_1_button_18_Template, 2, 0, "button", 78);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("disabled", ctx_r0.mesaActual.cerrada);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(i_r9 + 1);
    \u0275\u0275advance(3);
    \u0275\u0275styleProp("background", l_r7.colorPartido);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", l_r7.numeroLista || "?", " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(l_r7.nombre);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", l_r7.numeroLista);
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("background", (l_r7.colorPartido || "#666") + "20")("color", l_r7.colorPartido || "#666");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(l_r7.partidoNombre || "Independiente");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(l_r7.cargoNombre || "\u2014");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", !(ctx_r0.mesaActual == null ? null : ctx_r0.mesaActual.cerrada));
  }
}
function MesaVotacionComponent_div_13_ng_container_40_tr_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 81);
    \u0275\u0275text(2, "No hay listas que coincidan");
    \u0275\u0275elementEnd()();
  }
}
function MesaVotacionComponent_div_13_ng_container_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, MesaVotacionComponent_div_13_ng_container_40_tr_1_Template, 19, 15, "tr", 70)(2, MesaVotacionComponent_div_13_ng_container_40_tr_2_Template, 3, 0, "tr", 48);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r0.listasFiltradas);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.listasFiltradas.length === 0);
  }
}
function MesaVotacionComponent_div_13_ng_container_41_tr_1_div_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 84)(1, "input", 85, 0);
    \u0275\u0275twoWayListener("ngModelChange", function MesaVotacionComponent_div_13_ng_container_41_tr_1_div_17_Template_input_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext(4);
      \u0275\u0275twoWayBindingSet(ctx_r0.cantidadVotos, $event) || (ctx_r0.cantidadVotos = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("keyup.enter", function MesaVotacionComponent_div_13_ng_container_41_tr_1_div_17_Template_input_keyup_enter_1_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275listener("click", function MesaVotacionComponent_div_13_ng_container_41_tr_1_div_17_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r0.registrarVoto());
    });
    ...
    \u0275\u0275listener("click", function MesaVotacionComponent_div_13_ng_container_41_tr_1_div_17_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext(4);
...
function MesaVotacionComponent_div_13_ng_container_41_tr_1_button_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 80);
    \u0275\u0275listener("click", function MesaVotacionComponent_div_13_ng_container_41_tr_1_button_18_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r11);
      const c_r12 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.seleccionarCandidato(c_r12));
    });
    \u0275\u0275text(1, " Votar ");
    \u0275\u0275elementEnd();
  }
}
function MesaVotacionComponent_div_13_ng_container_41_tr_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "span", 71);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275template(17, MesaVotacionComponent_div_13_ng_container_41_tr_1_div_17_Template, 7, 3, "div", 83)(18, MesaVotacionComponent_div_13_ng_container_41_tr_1_button_18_Template, 2, 0, "button", 78);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("selected", (ctx_r0.candidatoSeleccionado == null ? null : ctx_r0.candidatoSeleccionado.id) === c_r12.id)("disabled", ctx_r0.mesaActual.cerrada);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(i_r13 + 1);
    \u0275\u0275advance(3);
    \u0275\u0275styleProp("background", c_r12.colorPartido);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", c_r12.nombre[0], "", c_r12.apellido[0], " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2("", c_r12.nombre, " ", c_r12.apellido, "");
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("background", c_r12.colorPartido + "20")("color", c_r12.colorPartido);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(c_r12.partidoNombre);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(c_r12.cargoNombre);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", (ctx_r0.candidatoSeleccionado == null ? null : ctx_r0.candidatoSeleccionado.id) === c_r12.id && !(ctx_r0.mesaActual == null ? null : ctx_r0.mesaActual.cerrada));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (ctx_r0.candidatoSeleccionado == null ? null : ctx_r0.candidatoSeleccionado.id) !== c_r12.id && !(ctx_r0.mesaActual == null ? null : ctx_r0.mesaActual.cerrada));
  }
}
function MesaVotacionComponent_div_13_ng_container_41_tr_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 81);
...
function MesaVotacionComponent_div_13_ng_container_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, MesaVotacionComponent_div_13_ng_container_41_tr_1_Template, 19, 19, "tr", 82)(2, MesaVotacionComponent_div_13_ng_container_41_tr_2_Template, 3, 0, "tr", 48);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function MesaVotacionComponent_div_13_tr_73_td_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "td", 60)(1, "button", 93);
    \u0275\u0275listener("click", function MesaVotacionComponent_div_13_tr_73_td_12_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r16);
      const v_r17 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.eliminarVoto(v_r17.id));
    });
    \u0275\u0275text(2, "\u2715");
    \u0275\u0275elementEnd()();
  }
...
function MesaVotacionComponent_div_13_tr_73_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "td")(7, "span", 76);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "td", 60)(10, "strong", 91);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(12, MesaVotacionComponent_div_13_tr_73_td_12_Template, 3, 0, "td", 92);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(v_r17.candidatoNombre ? v_r17.candidatoNombre + " " + (v_r17.candidatoApellido || "") : v_r17.listaId ? "Lista #" + v_r17.listaId : "\u2014");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(v_r17.partidoNombre || "\u2014");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(v_r17.cantidadVotos);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !(ctx_r0.mesaActual == null ? null : ctx_r0.mesaActual.cerrada));
  }
}
...
function MesaVotacionComponent_div_13_span_90_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "span", 94)(1, "button", 95);
...
function MesaVotacionComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MesaVotacionComponent_div_13_Template_th_click_25_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(!ctx_r0.mostrarListas && ctx_r0.setSortCandidatos("nombre"));
    });
    \u0275\u0275text(26);
    ...
    \u0275\u0275template(40, MesaVotacionComponent_div_13_ng_container_40_Template, 3, 2, "ng-container", 48)(41, MesaVotacionComponent_div_13_ng_container_41_Template, 3, 2, "ng-container", 48);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(42, "div", 49)(43, "div", 34)(44, "h3");
    \u0275\u0275text(45, "\u{1F4CB} Votos Registrados");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "div", 50)(47, "span", 51);
    \u0275\u0275text(48, "Total: ");
    \u0275\u0275elementStart(49, "strong");
    \u0275\u0275text(50);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(51, MesaVotacionComponent_div_13_button_51_Template, 2, 0, "button", 52)(52, MesaVotacionComponent_div_13_button_52_Template, 2, 0, "button", 53);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(53, "div", 42)(54, "table", 54)(55, "thead")(56, "tr")(57, "th", 44);
    \u0275\u0275text(58, "#");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(70);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(71, MesaVotacionComponent_div_13_th_71_Template, 2, 0, "th", 56);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(72, "tbody");
    \u0275\u0275template(73, MesaVotacionComponent_div_13_tr_73_Template, 13, 5, "tr", 57)(74, MesaVotacionComponent_div_13_tr_74_Template, 3, 0, "tr", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(75, "tfoot")(76, "tr", 58)(77, "td", 59)(78, "strong");
    \u0275\u0275text(79, "TOTAL");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(80, "td", 60)(81, "strong", 61);
    \u0275\u0275text(82);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(83, MesaVotacionComponent_div_13_td_83_Template, 1, 0, "td", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(84, "tr", 62);
    \u0275\u0275element(85, "td");
    \u0275\u0275elementStart(86, "td", 63)(87, "span", 64);
    \u0275\u0275text(88, "\u{1F5F3}\uFE0F Votos Nulos");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(89, "td", 60);
    \u0275\u0275template(90, MesaVotacionComponent_div_13_span_90_Template, 6, 1, "span", 65)(91, MesaVotacionComponent_div_13_strong_91_Template, 2, 1, "strong", 66);
    \u0275\u0275elementEnd();
    \u0275\u0275template(92, MesaVotacionComponent_div_13_td_92_Template, 1, 0, "td", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(93, "tr", 67);
    \u0275\u0275element(94, "td");
    \u0275\u0275elementStart(95, "td", 63)(96, "span", 68);
    \u0275\u0275text(97, "\u2B1C Votos en Blanco");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(98, "td", 60);
    \u0275\u0275template(99, MesaVotacionComponent_div_13_span_99_Template, 6, 1, "span", 65)(100, MesaVotacionComponent_div_13_strong_100_Template, 2, 1, "strong", 69);
    \u0275\u0275elementEnd();
    \u0275\u0275template(101, MesaVotacionComponent_div_13_td_101_Template, 1, 0, "td", 48);
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" ", ctx_r0.mostrarListas ? "Lista" : "Candidato", " ");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", ctx_r0.mostrarListas);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r0.mostrarListas);
    \u0275\u0275advance(9);
...
function MesaVotacionComponent_div_15_div_8_span_5_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r0.listaLlamada.numeroLista, "");
  }
}
function MesaVotacionComponent_div_15_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 111)(1, "span")(2, "strong");
    \u0275\u0275text(3, "Partido:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, MesaVotacionComponent_div_15_div_8_span_5_Template, 4, 1, "span", 48);
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ctx_r0.listaLlamada.partidoNombre || "Independiente", "");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.listaLlamada.numeroLista);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", (ctx_r0.listaLlamada.candidatos || \u0275\u0275pureFunction0(3, _c1)).length, "");
  }
}
function MesaVotacionComponent_div_15_table_9_tr_10_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", c_r22.nombre, " ", c_r22.apellido, "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(c_r22.cargoNombre || "\u2014");
  }
}
function MesaVotacionComponent_div_15_table_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "table", 112)(1, "thead")(2, "tr")(3, "th");
    \u0275\u0275text(4, "#");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "th");
    \u0275\u0275text(6, "Candidato");
    ...
    \u0275\u0275template(10, MesaVotacionComponent_div_15_table_9_tr_10_Template, 7, 4, "tr", 57);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(10);
    \u0275\u0275property("ngForOf", ctx_r0.listaLlamada.candidatos);
  }
}
function MesaVotacionComponent_div_15_div_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 113);
    \u0275\u0275text(1, " Cargando candidatos... ");
    \u0275\u0275elementEnd();
  }
}
function MesaVotacionComponent_div_15_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 114)(1, "label");
    \u0275\u0275text(2, "Cantidad de votos para toda la lista:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 115)(4, "button", 95);
    \u0275\u0275listener("click", function MesaVotacionComponent_div_15_div_11_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r24);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.decrementarCantidadLista());
    });
    \u0275\u0275text(5, "\u2212");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "input", 116);
    \u0275\u0275twoWayListener("ngModelChange", function MesaVotacionComponent_div_15_div_11_Template_input_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r24);
      const ctx_r0 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r0.cantidadLista, $event) || (ctx_r0.cantidadLista = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 97);
    \u0275\u0275listener("click", function MesaVotacionComponent_div_15_div_11_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r24);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.incrementarCantidadLista());
    });
    \u0275\u0275text(8, "+");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "button", 117);
    \u0275\u0275listener("click", function MesaVotacionComponent_div_15_div_11_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r24);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.votarLista());
    });
    \u0275\u0275text(10, "Votar Lista");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(6);
    \u0275\u0275twoWayProperty("ngModel", ctx_r0.cantidadLista);
  }
}
function MesaVotacionComponent_div_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r21 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 101)(1, "div", 102)(2, "div", 103)(3, "div", 104)(4, "h5");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function MesaVotacionComponent_div_15_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r21);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.cerrarListaModal());
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 106);
    \u0275\u0275template(8, MesaVotacionComponent_div_15_div_8_Template, 10, 4, "div", 107)(9, MesaVotacionComponent_div_15_table_9_Template, 11, 1, "table", 108)(10, MesaVotacionComponent_div_15_div_10_Template, 2, 0, "div", 109)(11, MesaVotacionComponent_div_15_div_11_Template, 11, 1, "div", 110);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("\u{1F4CB} ", (ctx_r0.listaLlamada == null ? null : ctx_r0.listaLlamada.nombre) || "Lista", "");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r0.listaLlamada);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (ctx_r0.listaLlamada == null ? null : ctx_r0.listaLlamada.candidatos) && ctx_r0.listaLlamada.candidatos.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !(ctx_r0.listaLlamada == null ? null : ctx_r0.listaLlamada.candidatos) || ctx_r0.listaLlamada.candidatos.length === 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !(ctx_r0.mesaActual == null ? null : ctx_r0.mesaActual.cerrada));
...
function MesaVotacionComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 100);
  }
}
function MesaVotacionComponent_div_17_div_11_Template(rf, ctx) {
  if (rf & 1) {
...
function MesaVotacionComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r25 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 101)(1, "div", 118)(2, "div", 103)(3, "div", 104)(4, "h5");
    \u0275\u0275text(5, "\u{1F5D1}\uFE0F Eliminar voto");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "button", 105);
    \u0275\u0275listener("click", function MesaVotacionComponent_div_17_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r25);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.cancelarDeleteVoto());
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 106)(8, "p");
    \u0275\u0275text(9, "Ingrese su contrase\xF1a para confirmar la eliminaci\xF3n:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "input", 119);
    \u0275\u0275twoWayListener("ngModelChange", function MesaVotacionComponent_div_17_Template_input_ngModelChange_10_listener($event) {
      \u0275\u0275restoreView(_r25);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.deletePassword, $event) || (ctx_r0.deletePassword = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("keyup.enter", function MesaVotacionComponent_div_17_Template_input_keyup_enter_10_listener() {
      \u0275\u0275restoreView(_r25);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.ejecutarDeleteVoto());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(11, MesaVotacionComponent_div_17_div_11_Template, 2, 1, "div", 120);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 121)(13, "button", 122);
    \u0275\u0275listener("click", function MesaVotacionComponent_div_17_Template_button_click_13_listener() {
      \u0275\u0275restoreView(_r25);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.cancelarDeleteVoto());
    });
    \u0275\u0275text(14, "Cancelar");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "button", 123);
    \u0275\u0275listener("click", function MesaVotacionComponent_div_17_Template_button_click_15_listener() {
      \u0275\u0275restoreView(_r25);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.ejecutarDeleteVoto());
    });
...
var MesaVotacionComponent = class _MesaVotacionComponent {
  ...
  loadData(eleccionId) {
    ...
    this.api.getListasByEleccion(eleccionId).subscribe((data) => {
      this.listas = data;
    });
  ...
  aplicarFiltro() {
    ...
    if (this.mostrarListas) {
      ...
      if (this.filtroTexto) {
        ...
        filtradas = filtradas.filter((l) => l.nombre.toLowerCase().includes(texto) || l.partidoNombre && l.partidoNombre.toLowerCase().includes(texto));
      }
      this.listasFiltradas = filtradas.map((l) => __spreadProps(__spreadValues({}, l), {
  ...
  abrirListaModal(lista) {
    this.listaLlamada = lista;
    this.cantidadLista = 1;
    this.showListaModal = true;
    if (!lista.candidatos || lista.candidatos.length === 0) {
      this.api.getListaDetalle(lista.id).subscribe((detalle) => {
        if (this.listaLlamada?.id === lista.id) {
          this.listaLlamada = __spreadProps(__spreadValues({}, lista), { candidatos: detalle.candidatos || [] });
        }
      });
    }
  }
  decrementarCantidadLista() {
    if (this.cantidadLista > 1)
      this.cantidadLista--;
  }
  incrementarCantidadLista() {
    this.cantidadLista++;
  }
  cerrarListaModal() {
    this.showListaModal = false;
  ...
  votarLista() {
    if (!this.mesaActual || !this.listaLlamada || this.mesaActual.cerrada)
      return;
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MesaVotacionComponent, selectors: [["app-mesa-votacion"]], viewQuery: function MesaVotacionComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(9, MesaVotacionComponent_div_9_Template, 8, 0, "div", 7)(10, MesaVotacionComponent_div_10_Template, 5, 1, "div", 8)(11, MesaVotacionComponent_div_11_Template, 11, 4, "div", 9)(12, MesaVotacionComponent_div_12_Template, 8, 0, "div", 10)(13, MesaVotacionComponent_div_13_Template, 102, 31, "div", 11)(14, MesaVotacionComponent_div_14_Template, 1, 0, "div", 12)(15, MesaVotacionComponent_div_15_Template, 12, 5, "div", 13)(16, MesaVotacionComponent_div_16_Template, 1, 0, "div", 12)(17, MesaVotacionComponent_div_17_Template, 17, 4, "div", 13);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(8);
        ...
        \u0275\u0275property("ngIf", ctx.mesaActual);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.showListaModal);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.showListaModal);
        \u0275\u0275advance();
