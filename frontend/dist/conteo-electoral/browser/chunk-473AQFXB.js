...
var require_stomp_umd = __commonJS({
  ...
  `;
      ...
      class StompHandler {
        ...
        constructor(_client, _webSocket, config) {
          ...
          this._serverFrameHandlers = {
            ...
            RECEIPT: (frame) => {
              const callback2 = this._receiptWatchers[frame.headers["receipt-id"]];
              if (callback2) {
                callback2(frame);
        ...
        watchForReceipt(receiptId, callback2) {
          this._receiptWatchers[receiptId] = callback2;
        }
        subscribe(destination, callback2, headers = {}) {
          headers = Object.assign({}, headers);
          if (!headers.id) {
            headers.id = `sub-${this._counter++}`;
          }
          headers.destination = destination;
          this._subscriptions[headers.id] = callback2;
      ...
      class Client2 {
        ...
        deactivate() {
          return __async(this, arguments, function* (options = {}) {
            ...
            this.webSocket.readyState !== exports2.StompSocketState.CLOSED) {
              ...
              retPromise = new Promise((resolve2, reject) => {
        ...
        watchForReceipt(receiptId, callback2) {
          this._checkConnection();
          this._stompHandler.watchForReceipt(receiptId, callback2);
        }
        /**
        ...
        subscribe(destination, callback2, headers = {}) {
          this._checkConnection();
          return this._stompHandler.subscribe(destination, callback2, headers);
        }
        /**
...
var require_browser = __commonJS({
  "node_modules/sockjs-client/node_modules/debug/src/browser.js"(exports, module) {
    ...
    var formatters2 = module.exports.formatters;
...
var require_ajax_based = __commonJS({
  "node_modules/sockjs-client/lib/transport/lib/ajax-based.js"(exports, module) {
    ...
    function createAjaxSender(AjaxObject) {
      return function(url, payload, callback2) {
        ...
        xo.once("finish", function(status) {
          ...
          if (status !== 200 && status !== 204) {
            return callback2(new Error("http status " + status));
          }
          callback2();
        });
        return function() {
...
var require_jsonp2 = __commonJS({
  "node_modules/sockjs-client/lib/transport/sender/jsonp.js"(exports, module) {
    ...
    module.exports = function(url, payload, callback2) {
      debug(url, payload);
      if (!form) {
        createForm();
      }
...
var require_shims = __commonJS({
  "node_modules/sockjs-client/lib/shims.js"() {
    ...
    var isArray2 = function isArray3(obj) {
    ...
    var defineProperties = function(object, map3, forceAssign) {
      for (var name in map3) {
        if (ObjectPrototype.hasOwnProperty.call(map3, name)) {
          defineProperty(object, name, map3[name], forceAssign);
        }
      }
    };
    ...
    defineProperties(Array, { isArray: isArray2 });
        ...
        var onMessage = function(e) {
          ...
          switch (iframeMessage.type) {
            case "s":
              ...
              var transUrl = p[2];
              var baseUrl = p[3];
              debug(version2, transport, transUrl, baseUrl);
...
var WebSocketService = class _WebSocketService {
  ...
  connect() {
    this.client = new import_stompjs.Client({
      webSocketFactory: () => new import_sockjs_client.default(`${environment.apiUrl.replace("/api", "")}/ws`),
      reconnectDelay: 5e3,
  ...
  subscribeToResultados(eleccionId) {
    return new Observable((observer) => {
      ...
      const trySubscribe = () => {
        ...
        try {
          const subscription = this.client.subscribe(`/topic/resultados/${eleccionId}`, (message) => {
            try {
  ...
  static {
    this.\u0275fac = function WebSocketService_Factory(t) {
      return new (t || _WebSocketService)(\u0275\u0275inject(AuthService));
    };
  }
  static {
...
function DashboardComponent_option_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 41);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", z_r4.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(z_r4.nombre);
  }
}
function DashboardComponent_option_50_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 41);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function DashboardComponent_option_57_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 41);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function DashboardComponent_option_71_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 41);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", i_r8.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(i_r8.nombre);
  }
}
...
function DashboardComponent_div_86_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 49)(13, "div", 44);
    \u0275\u0275text(14, "\u{1F4CB}");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 45)(16, "span", 46);
    \u0275\u0275text(17, "Mesas Totales");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "span", 47);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(20, "div", 50)(21, "div", 44);
    \u0275\u0275text(22, "\u{1F512}");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "div", 45)(24, "span", 46);
    \u0275\u0275text(25, "Mesas Cerradas");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(29, "div", 52);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "div", 53)(31, "div", 44);
    \u0275\u0275text(32, "\u{1F4C8}");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classProp("animating", ctx_r1.animando);
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 11, ctx_r1.dashboard.totalVotos));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("+", ctx_r1.dashboard.totalVotos > 0 ? "8.2%" : "0%", "");
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(ctx_r1.dashboard.totalMesas);
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(ctx_r1.dashboard.mesasCerradas);
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("width", ctx_r1.dashboard.porcentajeMesasCerradas * 100, "%");
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(38, 13, ctx_r1.dashboard.porcentajeMesasCerradas, "1.1-1"));
    \u0275\u0275advance(3);
    \u0275\u0275styleProp("width", ctx_r1.dashboard.porcentajeMesasCerradas * 100, "%");
  }
}
function DashboardComponent_tr_129_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "div", 55)(3, "span", 56);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "td", 59)(13, "strong");
    \u0275\u0275text(14);
    \u0275\u0275pipe(15, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "td", 59)(17, "span", 60);
    \u0275\u0275text(18);
    \u0275\u0275pipe(19, "percent");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275styleProp("animation-delay", i_r12 * 0.03 + "s");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(i_r12 + 1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(r_r11.nombreCompleto);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(r_r11.partidoNombre);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(r_r11.cargoNombre);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(15, 8, r_r11.totalVotos));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(19, 10, r_r11.porcentaje, "1.1-1"));
  }
}
...
var DashboardComponent = class _DashboardComponent {
  ...
  startPolling() {
    this.pollingSubscription?.unsubscribe();
    this.pollingSubscription = interval(15e3).subscribe(() => {
  ...
  recargarSilencioso() {
    if (!this.selectedEleccionId)
      return;
    this.animando = true;
    const tieneFiltros = this.filtroZonaId || this.filtroProvinciaId || this.filtroCantonId || this.filtroParroquiaId || this.filtroInstitucionId || this.filtroCargoId || this.filtroPartidoId;
    const obs = tieneFiltros ? this.api.getDashboardConFiltros(this.selectedEleccionId, this.filtroCargoId ?? void 0, this.filtroPartidoId ?? void 0, this.filtroZonaId ?? void 0, this.filtroProvinciaId ?? void 0, this.filtroCantonId ?? void 0, this.filtroParroquiaId ?? void 0, this.filtroInstitucionId ?? void 0) : this.api.getDashboard(this.selectedEleccionId);
    obs.subscribe((data) => {
      this.dashboard = data;
  ...
  aplicarFiltros() {
    if (!this.selectedEleccionId)
      return;
    this.api.getDashboardConFiltros(this.selectedEleccionId, this.filtroCargoId ?? void 0, this.filtroPartidoId ?? void 0, this.filtroZonaId ?? void 0, this.filtroProvinciaId ?? void 0, this.filtroCantonId ?? void 0, this.filtroParroquiaId ?? void 0, this.filtroInstitucionId ?? void 0).subscribe((data) => {
      this.dashboard = data;
      this.resultados = data.resultados || [];
      this.ordenarResultados();
      this.cdr.detectChanges();
  ...
  updateCharts() {
    ...
    const colors2 = ["#3b82f6", "#10b981", "#f59e0b", "#ef4444", "#8b5cf6", "#ec4899", "#14b8a6", "#f97316"];
    if (this.barChart) {
      this.barChart.data.labels = resultados.map((r) => r.nombreCompleto);
      this.barChart.data.datasets = [{
        data: resultados.map((r) => r.totalVotos),
        backgroundColor: colors2.slice(0, resultados.length)
      }];
  ...
  static {
    ...
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 131, vars: 46, consts: [["barChart", ""], ["pieChart", ""], [1, "dashboard-container"], [1, "dashboard-header"], [1, "header-left"], [1, "header-icon"], [1, "header-badges"], [1, "eleccion-badge"], [1, "live-badge", 3, "click"], [1, "live-dot"], ["class", "update-time", 4, "ngIf"], [1, "header-actions"], ["title", "Exportar a Excel", 1, "btn", "btn-excel", 3, "click"], ["title", "Exportar a PDF", 1, "btn", "btn-pdf", 3, "click"], [1, "btn", "btn-refresh", 3, "click"], [1, "btn", "btn-logout", 3, "click"], [1, "eleccion-selector"], [3, "change", "ngModelChange", "ngModel"], [3, "ngValue"], [3, "value", 4, "ngFor", "ngForOf"], [1, "filtros-card"], [1, "filtros-header"], [1, "btn", "btn-clean", 3, "click"], [1, "filtros-grid"], [1, "filtro-group"], [1, "form-select", 3, "ngModelChange", "change", "ngModel"], [1, "form-select", 3, "ngModelChange", "change", "ngModel", "disabled"], ["class", "stats-grid", 3, "animating", 4, "ngIf"], [1, "charts-grid"], [1, "chart-card"], [1, "table-card"], [1, "table-header"], [1, "table-count"], [1, "table-wrapper"], [1, "table-moderno"], [1, "sortable", 3, "click"], [1, "sort-icon"], [1, "sortable", "text-right", 3, "click"], [3, "animation-delay", 4, "ngFor", "ngForOf"], [4, "ngIf"], [1, "update-time"], [3, "value"], [1, "stats-grid"], [1, "stat-card", "stat-votos"], [1, "stat-icon"], [1, "stat-info"], [1, "stat-label"], [1, "stat-value"], [1, "stat-trend", "up"], [1, "stat-card", "stat-mesas"], [1, "stat-card", "stat-cerradas"], [1, "stat-bar"], [1, "stat-bar-fill"], [1, "stat-card", "stat-progreso"], [1, "stat-bar-fill", "progress-fill"], [1, "candidato-info-cell"], [1, "candidato-rank"], [1, "candidato-name"], [1, "partido-badge"], [1, "text-right"], [1, "porcentaje-badge"], ["colspan", "5", 1, "text-center", "empty-msg"]], template: function DashboardComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "div", 2)(1, "header", 3)(2, "div", 4)(3, "h1")(4, "span", 5);
        \u0275\u0275text(5, "\u{1F4CA}");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275listener("click", function DashboardComponent_Template_span_click_10_listener() {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275text(25, "Elecci\xF3n Activa:");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(26, "select", 17);
        \u0275\u0275listener("change", function DashboardComponent_Template_select_change_26_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onEleccionChange($event));
        });
        \u0275\u0275twoWayListener("ngModelChange", function DashboardComponent_Template_select_ngModelChange_26_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.selectedEleccionId, $event) || (ctx.selectedEleccionId = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275elementStart(27, "option", 18);
        \u0275\u0275text(28, "Seleccione...");
        \u0275\u0275elementEnd();
        \u0275\u0275template(29, DashboardComponent_option_29_Template, 2, 2, "option", 19);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(30, "div", 20)(31, "div", 21)(32, "h3");
        \u0275\u0275text(33, "\u{1F50D} Filtros de B\xFAsqueda");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(35, "Limpiar Filtros");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(36, "div", 23)(37, "div", 24)(38, "label");
        \u0275\u0275text(39, "Zona");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(40, "select", 25);
        \u0275\u0275twoWayListener("ngModelChange", function DashboardComponent_Template_select_ngModelChange_40_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.filtroZonaId, $event) || (ctx.filtroZonaId = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275listener("change", function DashboardComponent_Template_select_change_40_listener() {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275text(42, "Todas");
        \u0275\u0275elementEnd();
        \u0275\u0275template(43, DashboardComponent_option_43_Template, 2, 2, "option", 19);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(44, "div", 24)(45, "label");
        \u0275\u0275text(46, "Provincia");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(47, "select", 26);
        \u0275\u0275twoWayListener("ngModelChange", function DashboardComponent_Template_select_ngModelChange_47_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.filtroProvinciaId, $event) || (ctx.filtroProvinciaId = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275listener("change", function DashboardComponent_Template_select_change_47_listener() {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275text(49, "Todas");
        \u0275\u0275elementEnd();
        \u0275\u0275template(50, DashboardComponent_option_50_Template, 2, 2, "option", 19);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(51, "div", 24)(52, "label");
        \u0275\u0275text(53, "Cant\xF3n");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(54, "select", 26);
        \u0275\u0275twoWayListener("ngModelChange", function DashboardComponent_Template_select_ngModelChange_54_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.filtroCantonId, $event) || (ctx.filtroCantonId = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275listener("change", function DashboardComponent_Template_select_change_54_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onCantonChange());
        });
        \u0275\u0275elementStart(55, "option", 18);
        \u0275\u0275text(56, "Todos");
        \u0275\u0275elementEnd();
        \u0275\u0275template(57, DashboardComponent_option_57_Template, 2, 2, "option", 19);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(58, "div", 24)(59, "label");
        \u0275\u0275text(60, "Parroquia");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(61, "select", 26);
        \u0275\u0275twoWayListener("ngModelChange", function DashboardComponent_Template_select_ngModelChange_61_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.filtroParroquiaId, $event) || (ctx.filtroParroquiaId = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275listener("change", function DashboardComponent_Template_select_change_61_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onParroquiaChange());
        });
        \u0275\u0275elementStart(62, "option", 18);
        \u0275\u0275text(63, "Todas");
        \u0275\u0275elementEnd();
        \u0275\u0275template(64, DashboardComponent_option_64_Template, 2, 2, "option", 19);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(65, "div", 24)(66, "label");
        \u0275\u0275text(67, "Instituci\xF3n");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(68, "select", 26);
        \u0275\u0275twoWayListener("ngModelChange", function DashboardComponent_Template_select_ngModelChange_68_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.filtroInstitucionId, $event) || (ctx.filtroInstitucionId = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275listener("change", function DashboardComponent_Template_select_change_68_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onInstitucionChange());
        });
        \u0275\u0275elementStart(69, "option", 18);
        \u0275\u0275text(70, "Todas");
        \u0275\u0275elementEnd();
        \u0275\u0275template(71, DashboardComponent_option_71_Template, 2, 2, "option", 19);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(72, "div", 24)(73, "label");
        \u0275\u0275text(74, "Cargo");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(75, "select", 25);
        \u0275\u0275twoWayListener("ngModelChange", function DashboardComponent_Template_select_ngModelChange_75_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.filtroCargoId, $event) || (ctx.filtroCargoId = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275listener("change", function DashboardComponent_Template_select_change_75_listener() {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275text(77, "Todos");
        \u0275\u0275elementEnd();
        \u0275\u0275template(78, DashboardComponent_option_78_Template, 2, 2, "option", 19);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(79, "div", 24)(80, "label");
        \u0275\u0275text(81, "Partido");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(82, "select", 25);
        ...
        \u0275\u0275elementStart(83, "option", 18);
        \u0275\u0275text(84, "Todos");
        \u0275\u0275elementEnd();
        \u0275\u0275template(85, DashboardComponent_option_85_Template, 2, 2, "option", 19);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275template(86, DashboardComponent_div_86_Template, 41, 16, "div", 27);
        \u0275\u0275elementStart(87, "div", 28)(88, "div", 29)(89, "h3");
        \u0275\u0275text(90, "\u{1F4CA} Votos por Candidato");
        \u0275\u0275elementEnd();
        \u0275\u0275element(91, "canvas", null, 0);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(93, "div", 29)(94, "h3");
        \u0275\u0275text(95, "\u{1F967} Distribuci\xF3n de Votos");
        \u0275\u0275elementEnd();
        \u0275\u0275element(96, "canvas", null, 1);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(98, "div", 30)(99, "div", 31)(100, "h3");
        \u0275\u0275text(101, "\u{1F4CB} Resultados por Candidato");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(102, "span", 32);
        \u0275\u0275text(103);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(104, "div", 33)(105, "table", 34)(106, "thead")(107, "tr")(108, "th", 35);
        \u0275\u0275listener("click", function DashboardComponent_Template_th_click_108_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.setSortColumn("nombreCompleto"));
        });
        \u0275\u0275text(109, " Candidato ");
        \u0275\u0275elementStart(110, "span", 36);
        \u0275\u0275text(111);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(112, "th", 35);
        \u0275\u0275listener("click", function DashboardComponent_Template_th_click_112_listener() {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275listener("click", function DashboardComponent_Template_th_click_116_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.setSortColumn("cargoNombre"));
        });
        \u0275\u0275text(117, " Cargo ");
        \u0275\u0275elementStart(118, "span", 36);
        \u0275\u0275text(119);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(120, "th", 37);
        \u0275\u0275listener("click", function DashboardComponent_Template_th_click_120_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.setSortColumn("votos"));
        });
        \u0275\u0275text(121, " Votos ");
        \u0275\u0275elementStart(122, "span", 36);
        \u0275\u0275text(123);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(124, "th", 37);
        \u0275\u0275listener("click", function DashboardComponent_Template_th_click_124_listener() {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275template(129, DashboardComponent_tr_129_Template, 20, 13, "tr", 38)(130, DashboardComponent_tr_130_Template, 3, 0, "tr", 39);
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(9);
        ...
        \u0275\u0275advance();
        \u0275\u0275classProp("active", ctx.autoRefresh);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1(" ", ctx.autoRefresh ? "EN VIVO" : "PAUSADO", " ");
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.ultimaActualizacion);
        \u0275\u0275advance(6);
        \u0275\u0275classProp("spinning", ctx.animando);
        \u0275\u0275advance(7);
        ...
        \u0275\u0275advance(12);
        \u0275\u0275classProp("animating", ctx.animando);
        \u0275\u0275advance(5);
...
chart.js/dist/chart.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-473AQFXB.js.map
