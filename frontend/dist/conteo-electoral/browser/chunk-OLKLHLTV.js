...
// src/app/features/admin/pages/provincias/provincias.component.ts
function ProvinciasComponent_option_34_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", z_r1.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(z_r1.nombre);
  }
}
function ProvinciasComponent_tr_52_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ProvinciasComponent_tr_52_Template_button_click_15_listener() {
      const p_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.edit(p_r3));
    });
    \u0275\u0275text(16, "Editar");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("click", function ProvinciasComponent_tr_52_Template_button_click_20_listener() {
      const p_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.delete(p_r3.id));
    });
    \u0275\u0275text(21, "Eliminar");
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(p_r3.zonaNombre);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(p_r3.descripcion || "N/A");
  }
}
function ProvinciasComponent_tr_53_Template(rf, ctx) {
  if (rf & 1) {
...
function ProvinciasComponent_span_62_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span")(1, "button", 30);
    \u0275\u0275listener("click", function ProvinciasComponent_span_62_Template_button_click_1_listener() {
...
function ProvinciasComponent_option_71_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 25);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ProvinciasComponent_div_72_span_20_Template(rf, ctx) {
  if (rf & 1) {
...
function ProvinciasComponent_div_72_span_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ProvinciasComponent_div_72_div_22_tr_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(row_r10.zona);
  }
}
function ProvinciasComponent_div_72_div_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(15, ProvinciasComponent_div_72_div_22_tr_15_Template, 7, 3, "tr", 16);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
...
function ProvinciasComponent_div_72_div_23_Template(rf, ctx) {
  if (rf & 1) {
...
function ProvinciasComponent_div_72_div_24_li_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ProvinciasComponent_div_72_div_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 51)(1, "p")(2, "strong");
    \u0275\u0275text(3, "Errores:");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "ul");
    \u0275\u0275template(5, ProvinciasComponent_div_72_div_24_li_5_Template, 2, 1, "li", 16);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
...
function ProvinciasComponent_div_72_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 31)(1, "div", 32)(2, "div", 33)(3, "div", 34)(4, "h5");
    \u0275\u0275text(5, "\u{1F4E5} Importar Provincias desde Excel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "button", 35);
    \u0275\u0275listener("click", function ProvinciasComponent_div_72_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("change", function ProvinciasComponent_div_72_Template_input_change_18_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275template(20, ProvinciasComponent_div_72_span_20_Template, 2, 0, "span", 17)(21, ProvinciasComponent_div_72_span_21_Template, 2, 1, "span", 17);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(22, ProvinciasComponent_div_72_div_22_Template, 16, 2, "div", 41)(23, ProvinciasComponent_div_72_div_23_Template, 2, 5, "div", 42)(24, ProvinciasComponent_div_72_div_24_Template, 6, 1, "div", 43);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "div", 44)(26, "button", 45);
    \u0275\u0275listener("click", function ProvinciasComponent_div_72_Template_button_click_26_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.closeImportModal());
    });
    ...
    \u0275\u0275listener("click", function ProvinciasComponent_div_72_Template_button_click_28_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
...
function ProvinciasComponent_div_73_div_9_Template(rf, ctx) {
  if (rf & 1) {
...
function ProvinciasComponent_div_73_option_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 25);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", z_r13.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(z_r13.nombre);
  }
}
function ProvinciasComponent_div_73_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "button", 35);
    \u0275\u0275listener("click", function ProvinciasComponent_div_73_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275template(9, ProvinciasComponent_div_73_div_9_Template, 3, 1, "div", 52);
    \u0275\u0275elementStart(10, "div", 53)(11, "label");
    \u0275\u0275text(12, "Nombre:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "input", 54);
    \u0275\u0275twoWayListener("ngModelChange", function ProvinciasComponent_div_73_Template_input_ngModelChange_13_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.form.nombre, $event) || (ctx_r3.form.nombre = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function ProvinciasComponent_div_73_Template_input_input_13_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ProvinciasComponent_div_73_Template_select_ngModelChange_17_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.form.zonaId, $event) || (ctx_r3.form.zonaId = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(18, "option", 11);
    \u0275\u0275text(19, "Seleccione...");
    \u0275\u0275elementEnd();
    \u0275\u0275template(20, ProvinciasComponent_div_73_option_20_Template, 2, 2, "option", 12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 53)(22, "label");
    \u0275\u0275text(23, "Descripci\xF3n:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "textarea", 56);
    \u0275\u0275twoWayListener("ngModelChange", function ProvinciasComponent_div_73_Template_textarea_ngModelChange_24_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.form.descripcion, $event) || (ctx_r3.form.descripcion = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function ProvinciasComponent_div_73_Template_textarea_input_24_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(25, "div", 44)(26, "button", 45);
    \u0275\u0275listener("click", function ProvinciasComponent_div_73_Template_button_click_26_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.closeModal());
    });
    ...
    \u0275\u0275listener("click", function ProvinciasComponent_div_73_Template_button_click_28_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r3 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", ctx_r3.editMode ? "Editar" : "Nueva", " Provincia");
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", ctx_r3.errorMessage);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.form.nombre);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.form.zonaId);
    \u0275\u0275advance();
    \u0275\u0275property("ngValue", null);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r3.zonas);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.form.descripcion);
  }
}
var ProvinciasComponent = class _ProvinciasComponent {
  constructor(api) {
    this.api = api;
    this.provincias = [];
    this.zonas = [];
    ...
    this.form = { nombre: "", zonaId: null, descripcion: "" };
  ...
  load() {
    const obs = this.filterZonaId ? this.api.getProvinciasByZona(this.filterZonaId) : this.api.getProvincias();
    obs.subscribe((d) => this.provincias = d);
  }
  filtrarPorZona() {
    this.load();
    this.currentPage = 1;
  ...
  get provinciasFiltradas() {
    if (!this.searchText)
      return this.provinciasOrdenadas;
    const term = this.searchText.toLowerCase();
    return this.provinciasOrdenadas.filter((item) => Object.values(item).some((v) => v != null && String(v).toLowerCase().includes(term)));
  }
  get provinciasPaginadas() {
  ...
  delete(id) {
    if (confirm("\xBFEst\xE1 seguro de eliminar esta provincia?")) {
      this.api.deleteProvincia(id).subscribe(() => this.load());
    }
  }
  descargarTemplate() {
    const data = [["nombre", "zona"], ["PROVINCIA EJEMPLO", "ZONA EJEMPLO"]];
    const ws = utils.aoa_to_sheet(data);
    ws["!cols"] = [{ wch: 30 }, { wch: 30 }];
    const wb = utils.book_new();
    utils.book_append_sheet(wb, ws, "Provincias");
    writeFileSync(wb, "plantilla_provincias.xlsx");
  }
  openImportModal() {
  ...
  onImportFileSelected(event) {
    ...
    if (!this.importFile)
      return;
    this.api.getZonas().subscribe((zonas) => this.zonas = zonas);
  ...
  importar() {
    ...
    this.importPreview.forEach((item) => {
      ...
      if (!item.zona || !zona) {
        errors++;
        this.importErrors.push(`Fila ${item.index}: zona "${item.zona}" no encontrada`);
        completed++;
        return;
      }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProvinciasComponent, selectors: [["app-provincias"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 74, vars: 21, consts: [[1, "container"], [1, "page-header"], [1, "dropdown"], ["type", "button", "data-bs-toggle", "dropdown", "data-bs-popper", "false", "aria-expanded", "false", 1, "btn", "btn-primary", "dropdown-toggle"], [1, "dropdown-menu", "dropdown-menu-end"], [1, "dropdown-item", "fw-bold", 3, "click"], [1, "dropdown-divider"], [1, "dropdown-item", 3, "click"], [1, "filters-bar", "mb-4"], [1, "filter-item"], [1, "form-select", 3, "ngModelChange", "change", "ngModel"], [3, "ngValue"], [3, "value", 4, "ngFor", "ngForOf"], ["type", "text", "autocomplete", "off", "placeholder", "Buscar en tabla...", 1, "form-control", 3, "ngModelChange", "input", "ngModel"], [1, "table", "table-striped"], [1, "sortable", 3, "click"], [4, "ngFor", "ngForOf"], [4, "ngIf"], [1, "pagination-bar"], [1, "pagination-info"], [1, "pagination-controls"], [3, "click", "disabled"], [1, "pagination-size"], [3, "ngModelChange", "change", "ngModel"], ["class", "modal", 4, "ngIf"], [3, "value"], ["type", "button", "data-bs-toggle", "dropdown", "data-bs-popper", "false", "aria-expanded", "false", 1, "btn", "btn-sm", "btn-outline-secondary", "border-0"], [1, "bi", "bi-three-dots-vertical"], [1, "dropdown-item", "text-danger", 3, "click"], ["colspan", "5", 1, "text-center", "py-3"], [3, "click"], [1, "modal"], [1, "modal-dialog"], [1, "modal-content"], [1, "modal-header"], [1, "btn-close", 3, "click"], [1, "modal-body"], [1, "text-muted", "mb-3"], [1, "upload-section", "mb-3"], ["type", "file", "autocomplete", "off", "accept", ".xlsx,.xls", "id", "importFileInput", 3, "change"], ["for", "importFileInput", 1, "file-label"], ["class", "import-preview", 4, "ngIf"], ["class", "alert", 3, "alert-success", "alert-warning", 4, "ngIf"], ["class", "errores-list", 4, "ngIf"], [1, "modal-footer"], [1, "btn", "btn-secondary", 3, "click"], [1, "btn", "btn-primary", 3, "click", "disabled"], [1, "import-preview"], [1, "preview-table-wrapper"], [1, "table", "table-sm"], [1, "alert"], [1, "errores-list"], ["class", "mb-3", 4, "ngIf"], [1, "mb-3"], ["type", "text", "autocomplete", "off", 1, "form-control", 3, "ngModelChange", "input", "ngModel"], [1, "form-select", 3, "ngModelChange", "ngModel"], ["autocomplete", "off", 1, "form-control", 3, "ngModelChange", "input", "ngModel"], [1, "btn", "btn-primary", 3, "click"], [1, "alert", "alert-danger"]], template: function ProvinciasComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275listener("click", function ProvinciasComponent_Template_button_click_22_listener() {
          return ctx.api.exportProvinciasPdf();
        });
        \u0275\u0275text(23, "\u{1F4C4} Imprimir PDF");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(24, "li")(25, "button", 7);
        \u0275\u0275listener("click", function ProvinciasComponent_Template_button_click_25_listener() {
          return ctx.api.exportProvinciasExcel();
        });
        ...
        \u0275\u0275twoWayListener("ngModelChange", function ProvinciasComponent_Template_select_ngModelChange_31_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.filterZonaId, $event) || (ctx.filterZonaId = $event);
          return $event;
        });
        \u0275\u0275listener("change", function ProvinciasComponent_Template_select_change_31_listener() {
          return ctx.filtrarPorZona();
        });
        \u0275\u0275elementStart(32, "option", 11);
        \u0275\u0275text(33, "Todas");
        \u0275\u0275elementEnd();
        \u0275\u0275template(34, ProvinciasComponent_option_34_Template, 2, 2, "option", 12);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(35, "div", 9)(36, "label");
        \u0275\u0275text(37, "Buscar:");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(38, "input", 13);
        \u0275\u0275twoWayListener("ngModelChange", function ProvinciasComponent_Template_input_ngModelChange_38_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.searchText, $event) || (ctx.searchText = $event);
          return $event;
        });
        \u0275\u0275listener("input", function ProvinciasComponent_Template_input_input_38_listener() {
        ...
        \u0275\u0275listener("click", function ProvinciasComponent_Template_th_click_44_listener() {
          return ctx.sort("nombre");
        });
        \u0275\u0275text(45);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(46, "th", 15);
        \u0275\u0275listener("click", function ProvinciasComponent_Template_th_click_46_listener() {
          return ctx.sort("zonaNombre");
        });
        \u0275\u0275text(47);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(48, "th", 15);
        \u0275\u0275listener("click", function ProvinciasComponent_Template_th_click_48_listener() {
        ...
        \u0275\u0275template(52, ProvinciasComponent_tr_52_Template, 22, 4, "tr", 16)(53, ProvinciasComponent_tr_53_Template, 3, 0, "tr", 17);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(54, "div", 18)(55, "div", 19);
        \u0275\u0275text(56);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(57, "div", 20)(58, "button", 21);
        \u0275\u0275listener("click", function ProvinciasComponent_Template_button_click_58_listener() {
          return ctx.goToPage(1);
        });
        \u0275\u0275text(59, "\xAB\xAB");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(60, "button", 21);
        \u0275\u0275listener("click", function ProvinciasComponent_Template_button_click_60_listener() {
          return ctx.prevPage();
        });
        \u0275\u0275text(61, "\xAB");
        \u0275\u0275elementEnd();
        \u0275\u0275template(62, ProvinciasComponent_span_62_Template, 3, 3, "span", 16);
        \u0275\u0275elementStart(63, "button", 21);
        \u0275\u0275listener("click", function ProvinciasComponent_Template_button_click_63_listener() {
          return ctx.nextPage();
        });
        \u0275\u0275text(64, "\xBB");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(65, "button", 21);
        \u0275\u0275listener("click", function ProvinciasComponent_Template_button_click_65_listener() {
        ...
        \u0275\u0275twoWayListener("ngModelChange", function ProvinciasComponent_Template_select_ngModelChange_70_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.pageSize, $event) || (ctx.pageSize = $event);
          return $event;
        });
        \u0275\u0275listener("change", function ProvinciasComponent_Template_select_change_70_listener() {
          return ctx.onPageSizeChange();
        });
        \u0275\u0275template(71, ProvinciasComponent_option_71_Template, 2, 2, "option", 12);
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(72, ProvinciasComponent_div_72_Template, 30, 7, "div", 24)(73, ProvinciasComponent_div_73_Template, 30, 7, "div", 24);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(31);
        \u0275\u0275twoWayProperty("ngModel", ctx.filterZonaId);
        \u0275\u0275advance();
        \u0275\u0275property("ngValue", null);
        \u0275\u0275advance(2);
        ...
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1("Zona ", ctx.sortColumn === "zonaNombre" ? ctx.sortDirection === "asc" ? "\u25B2" : "\u25BC" : "", "");
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1("Descripci\xF3n ", ctx.sortColumn === "descripcion" ? ctx.sortDirection === "asc" ? "\u25B2" : "\u25BC" : "", "");
        \u0275\u0275advance(3);
        \u0275\u0275property("ngForOf", ctx.provinciasPaginadas);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.provinciasFiltradas.length === 0);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate3(" Mostrando ", (ctx.currentPage - 1) * ctx.pageSize + 1, " - ", ctx.Math.min(ctx.currentPage * ctx.pageSize, ctx.provinciasFiltradas.length), " de ", ctx.provinciasFiltradas.length, " registros ");
        \u0275\u0275advance(2);
