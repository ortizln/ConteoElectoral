...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-QZGBJZPL.js").then((m) => m.LoginComponent)
  },
  {
    path: "admin",
    canActivate: [authGuard, roleGuard],
    data: { roles: ["ADMIN"] },
    loadChildren: () => import("./chunk-MXKBRNO2.js").then((m) => m.ADMIN_ROUTES)
  },
  {
    path: "dashboard",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-7NKGEESH.js").then((m) => m.ContentLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-PD7EJY2T.js").then((m) => m.DashboardComponent)
      }
    ]
  },
  {
    ...
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-OJJP5DZN.js").then((m) => m.MesaVotacionComponent)
      },
      {
        path: "papeletas",
        loadComponent: () => import("./chunk-PA63SRJX.js").then((m) => m.MesaVotacionPapeletaComponent)
      }
    ]
  },
