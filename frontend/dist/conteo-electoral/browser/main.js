...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-MVO6LZQK.js").then((m) => m.LoginComponent)
  },
  {
    path: "admin",
    canActivate: [authGuard, roleGuard],
    data: { roles: ["ADMIN", "SUPERVISOR"] },
    loadChildren: () => import("./chunk-2TM2U3YL.js").then((m) => m.ADMIN_ROUTES)
  },
  {
    path: "dashboard",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-473AQFXB.js").then((m) => m.DashboardComponent)
  },
  {
    path: "mesa",
    canActivate: [authGuard, roleGuard],
    data: { roles: ["MIEMBRO_MESA", "ADMIN", "SUPERVISOR"] },
    loadComponent: () => import("./chunk-S4YPRYXL.js").then((m) => m.MesaVotacionComponent)
  },
