...
function DashboardComponent_div_82_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(24, "Votos en Blanco");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "span", 54);
    \u0275\u0275text(26);
    \u0275\u0275pipe(27, "number");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(28, "div", 57)(29, "div", 51);
    \u0275\u0275text(30, "\u{1F4CB}");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "div", 52)(32, "span", 53);
    \u0275\u0275text(33, "Mesas Totales");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "span", 54);
    \u0275\u0275text(35);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(36, "div", 58);
    \u0275\u0275listener("click", function DashboardComponent_div_82_Template_div_click_36_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(41, "Mesas Cerradas");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "span", 54);
    \u0275\u0275text(43);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(44, "div", 59);
    \u0275\u0275element(45, "div", 60);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "div", 61)(47, "div", 51);
    \u0275\u0275text(48, "\u{1F4C8}");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "div", 52)(50, "span", 53);
    \u0275\u0275text(51, "Progreso");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "span", 54);
    \u0275\u0275text(53);
    \u0275\u0275pipe(54, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(55, "div", 59);
    \u0275\u0275element(56, "div", 62);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 10, ctx_r1.dashboard.totalVotos));
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(18, 12, ctx_r1.dashboard.totalVotosNulos));
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(27, 14, ctx_r1.dashboard.totalVotosBlanco));
    \u0275\u0275advance(9);
    ...
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind2(54, 16, ctx_r1.dashboard.porcentajeMesasCerradas, "1.1-1"), "%");
    \u0275\u0275advance(3);
    \u0275\u0275styleProp("width", ctx_r1.dashboard.porcentajeMesasCerradas, "%");
  }
}
function DashboardComponent_tr_144_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "td")(2, "div", 64)(3, "span", 65);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "td", 68)(13, "strong");
    \u0275\u0275text(14);
    \u0275\u0275pipe(15, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "td", 68)(17, "span", 69);
    \u0275\u0275text(18);
    \u0275\u0275pipe(19, "number");
    \u0275\u0275elementEnd()()();
  }
...
function DashboardComponent_div_148_div_8_div_19_tr_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "td", 68)(11, "strong");
    \u0275\u0275text(12);
    \u0275\u0275pipe(13, "number");
    \u0275\u0275elementEnd()()();
  }
...
function DashboardComponent_div_148_div_8_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 93)(1, "div", 94)(2, "table", 95)(3, "thead")(4, "tr")(5, "th");
    \u0275\u0275text(6, "#");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "th");
    \u0275\u0275text(8, "Mesa");
    ...
    \u0275\u0275template(16, DashboardComponent_div_148_div_8_div_19_tr_16_Template, 14, 7, "tr", 96)(17, DashboardComponent_div_148_div_8_div_19_tr_17_Template, 3, 0, "tr", 43);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function DashboardComponent_div_148_div_8_div_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "geo-group-table", 98);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function DashboardComponent_div_148_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "div", 85)(2, "div", 86)(3, "span")(4, "strong");
    \u0275\u0275text(5, "Partido:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(16, "number");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(17, "ul", 88);
    \u0275\u0275template(18, DashboardComponent_div_148_div_8_li_18_Template, 3, 6, "li", 89);
    \u0275\u0275elementEnd();
    \u0275\u0275template(19, DashboardComponent_div_148_div_8_div_19_Template, 18, 2, "div", 90)(20, DashboardComponent_div_148_div_8_div_20_Template, 2, 2, "div", 90)(21, DashboardComponent_div_148_div_8_div_21_Template, 2, 2, "div", 90)(22, DashboardComponent_div_148_div_8_div_22_Template, 2, 2, "div", 90)(23, DashboardComponent_div_148_div_8_div_23_Template, 2, 2, "div", 90)(24, DashboardComponent_div_148_div_8_div_24_Template, 2, 2, "div", 90);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function DashboardComponent_div_148_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(7, DashboardComponent_div_148_div_7_Template, 4, 0, "div", 79)(8, DashboardComponent_div_148_div_8_Template, 25, 12, "div", 43);
    \u0275\u0275elementEnd();
...
function DashboardComponent_div_150_div_10_tr_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(15, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "td", 104)(17, "button", 106);
    ...
    \u0275\u0275element(18, "i", 107);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "td", 104)(20, "button", 108);
...
function DashboardComponent_div_150_div_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 94)(1, "table", 95)(2, "thead")(3, "tr")(4, "th");
    \u0275\u0275text(5, "#");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th");
    \u0275\u0275text(7, "Mesa");
    ...
    \u0275\u0275text(15, "Votos");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "th", 104);
    \u0275\u0275text(17, "Acta");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "th", 104);
    \u0275\u0275text(19, "Acci\xF3n");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(20, "tbody");
    \u0275\u0275template(21, DashboardComponent_div_150_div_10_tr_21_Template, 23, 10, "tr", 96);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function DashboardComponent_div_150_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 73)(1, "div", 99)(2, "div", 75)(3, "div", 76)(4, "h5");
    ...
    \u0275\u0275template(8, DashboardComponent_div_150_div_8_Template, 4, 0, "div", 79)(9, DashboardComponent_div_150_div_9_Template, 2, 0, "div", 100)(10, DashboardComponent_div_150_div_10_Template, 22, 1, "div", 101);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 80)(12, "button", 81);
...
function DashboardComponent_div_152_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 73)(1, "div", 110)(2, "div", 75)(3, "div", 76)(4, "h5");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(14, DashboardComponent_div_152_div_14_Template, 2, 1, "div", 112);
    \u0275\u0275elementEnd();
...
var DashboardComponent = class _DashboardComponent {
  ...
  procesarResultados(data) {
    ...
    if (this.showListaResults && data.resultadosListas?.length) {
      ...
      const resultados2 = data.resultadosListas.map((r) => ({
      ...
      const totalVotosNulos2 = data.totalVotosNulos || 0;
      const totalVotosBlanco2 = data.totalVotosBlanco || 0;
      const totalGeneral2 = data.totalVotos + totalVotosNulos2 + totalVotosBlanco2;
      if (totalVotosNulos2 > 0) {
        resultados2.push({
          candidatoId: 0,
          nombreCompleto: "Votos Nulos",
          partidoNombre: "\u2014",
          cargoNombre: "\u2014",
          totalVotos: totalVotosNulos2,
          porcentaje: totalGeneral2 > 0 ? Math.round(totalVotosNulos2 * 1e4 / totalGeneral2) / 100 : 0
        });
      }
      if (totalVotosBlanco2 > 0) {
        resultados2.push({
          candidatoId: -1,
          nombreCompleto: "Votos en Blanco",
          partidoNombre: "\u2014",
          cargoNombre: "\u2014",
          totalVotos: totalVotosBlanco2,
          porcentaje: totalGeneral2 > 0 ? Math.round(totalVotosBlanco2 * 1e4 / totalGeneral2) / 100 : 0
        });
      }
    ...
    if (totalVotosBlanco > 0) {
      resultados.push({
        ...
        porcentaje: totalGeneral > 0 ? Math.round(totalVotosBlanco * 1e4 / totalGeneral) / 100 : 0
      });
    }
  ...
  computeTop3() {
    ...
    for (const r of this.resultadosOrdenados) {
      if (r.candidatoId === 0 || r.candidatoId === -1 || (r.candidatoId ?? 0) < -1)
        continue;
  ...
  getRowClass(r) {
    ...
    if (topSet?.has(r.nombreCompleto)) {
      const idx = [...this.resultadosOrdenados.filter((x) => x.cargoNombre === r.cargoNombre && x.candidatoId !== 0 && x.candidatoId !== -1)].sort((a, b) => b.totalVotos - a.totalVotos).findIndex((x) => x.nombreCompleto === r.nombreCompleto);
  ...
  getRankClass(r) {
    ...
    if (r.candidatoId === -1)
      return "candidato-rank rank-blanco";
    const topSet = this.top3Cargos.get(r.cargoNombre);
    if (topSet?.has(r.nombreCompleto)) {
      const idx = [...this.resultadosOrdenados.filter((x) => x.cargoNombre === r.cargoNombre && x.candidatoId !== 0 && x.candidatoId !== -1)].sort((a, b) => b.totalVotos - a.totalVotos).findIndex((x) => x.nombreCompleto === r.nombreCompleto);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-dashboard"]], viewQuery: function DashboardComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275template(82, DashboardComponent_div_82_Template, 57, 19, "div", 28);
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1("\u{1F4CB} ", ctx.showListaResults ? "Resultados por Lista" : "Resultados por Candidato", "");
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate2("", ctx.resultados.length, " ", ctx.showListaResults ? "listas" : "candidatos", "");
        \u0275\u0275advance();
        ...
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", ctx.showListaResults ? "Lista" : "Candidato", " ");
        \u0275\u0275advance(2);
