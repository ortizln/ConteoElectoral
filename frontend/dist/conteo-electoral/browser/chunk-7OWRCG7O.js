...
var WebSocketService = class _WebSocketService {
  ...
  subscribeToResultados(eleccionId) {
    return this.subscribeToTopic(`/topic/resultados/${eleccionId}`);
  }
  subscribeToMesaEstado(eleccionId) {
    return this.subscribeToTopic(`/topic/mesa-estado/${eleccionId}`);
  }
...
//# sourceMappingURL=chunk-7OWRCG7O.js.map
