...
function InstitucionesComponent_option_20_Template(rf, ctx) {
  if (rf & 1) {
...
function InstitucionesComponent_tr_41_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function InstitucionesComponent_tr_41_Template_button_click_12_listener() {
    ...
    \u0275\u0275listener("click", function InstitucionesComponent_tr_41_Template_button_click_14_listener() {
      const i_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.delete(i_r3.id));
    });
    \u0275\u0275text(15, "Eliminar");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((ctx_r3.currentPage - 1) * ctx_r3.pageSize + idx_r5 + 1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(i_r3.nombre);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(i_r3.parroquiaNombre);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(i_r3.codigo || "N/A");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(i_r3.tipo || "N/A");
  }
}
function InstitucionesComponent_tr_42_Template(rf, ctx) {
  if (rf & 1) {
...
function InstitucionesComponent_span_51_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span")(1, "button", 28);
    \u0275\u0275listener("click", function InstitucionesComponent_span_51_Template_button_click_1_listener() {
...
function InstitucionesComponent_option_60_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 24);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function InstitucionesComponent_div_61_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 36)(1, "div", 45);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function InstitucionesComponent_div_61_option_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 24);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function InstitucionesComponent_div_61_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function InstitucionesComponent_div_61_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275template(9, InstitucionesComponent_div_61_div_9_Template, 3, 1, "div", 35);
    \u0275\u0275elementStart(10, "div", 36)(11, "label");
    \u0275\u0275text(12, "Nombre:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "input", 37);
    \u0275\u0275twoWayListener("ngModelChange", function InstitucionesComponent_div_61_Template_input_ngModelChange_13_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.form.nombre, $event) || (ctx_r3.form.nombre = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function InstitucionesComponent_div_61_Template_input_input_13_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function InstitucionesComponent_div_61_Template_select_ngModelChange_17_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.form.parroquiaId, $event) || (ctx_r3.form.parroquiaId = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(18, "option", 10);
    \u0275\u0275text(19, "Seleccione...");
    \u0275\u0275elementEnd();
    \u0275\u0275template(20, InstitucionesComponent_div_61_option_20_Template, 2, 2, "option", 11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 36)(22, "label");
    \u0275\u0275text(23, "Direcci\xF3n:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "textarea", 39);
    \u0275\u0275twoWayListener("ngModelChange", function InstitucionesComponent_div_61_Template_textarea_ngModelChange_24_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.form.direccion, $event) || (ctx_r3.form.direccion = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function InstitucionesComponent_div_61_Template_textarea_input_24_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.toUpper(ctx_r3.form, "direccion"));
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(29, "\u24D8");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "input", 37);
    \u0275\u0275twoWayListener("ngModelChange", function InstitucionesComponent_div_61_Template_input_ngModelChange_30_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.form.codigo, $event) || (ctx_r3.form.codigo = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function InstitucionesComponent_div_61_Template_input_input_30_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.toUpper(ctx_r3.form, "codigo"));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "div", 36)(32, "label");
    \u0275\u0275text(33, " Tipo: ");
    \u0275\u0275elementStart(34, "span", 41);
    \u0275\u0275text(35, "\u24D8");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "input", 37);
    \u0275\u0275twoWayListener("ngModelChange", function InstitucionesComponent_div_61_Template_input_ngModelChange_36_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.form.tipo, $event) || (ctx_r3.form.tipo = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function InstitucionesComponent_div_61_Template_input_input_36_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.toUpper(ctx_r3.form, "tipo"));
    });
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(37, "div", 42)(38, "button", 43);
    \u0275\u0275listener("click", function InstitucionesComponent_div_61_Template_button_click_38_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.closeModal());
    });
    ...
    \u0275\u0275listener("click", function InstitucionesComponent_div_61_Template_button_click_40_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r3 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", ctx_r3.editMode ? "Editar" : "Nueva", " Instituci\xF3n");
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", ctx_r3.errorMessage);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.form.nombre);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.form.parroquiaId);
    \u0275\u0275advance();
    \u0275\u0275property("ngValue", null);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r3.parroquias);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.form.direccion);
    \u0275\u0275advance(6);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.form.codigo);
    \u0275\u0275advance(6);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.form.tipo);
  }
}
var InstitucionesComponent = class _InstitucionesComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InstitucionesComponent, selectors: [["app-instituciones"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 62, vars: 21, consts: [[1, "container"], [1, "page-header"], [1, "export-buttons"], ["title", "Exportar a Excel", 1, "btn", "btn-excel", 3, "click"], ["title", "Exportar a PDF", 1, "btn", "btn-pdf", 3, "click"], [1, "btn", "btn-primary", "btn-with-icon", 3, "click"], [1, "btn-icon"], [1, "filters-bar", "mb-4"], [1, "filter-item"], [1, "form-select", 3, "ngModelChange", "change", "ngModel"], [3, "ngValue"], [3, "value", 4, "ngFor", "ngForOf"], ["type", "text", "placeholder", "Buscar en tabla...", 1, "form-control", 3, "ngModelChange", "input", "ngModel"], [1, "table", "table-striped"], [1, "sortable", 3, "click"], [4, "ngFor", "ngForOf"], [4, "ngIf"], [1, "pagination-bar"], [1, "pagination-info"], [1, "pagination-controls"], [3, "click", "disabled"], [1, "pagination-size"], [3, "ngModelChange", "change", "ngModel"], ["class", "modal", 4, "ngIf"], [3, "value"], [1, "btn", "btn-sm", "btn-warning", 3, "click"], [1, "btn", "btn-sm", "btn-danger", 3, "click"], ["colspan", "6", 1, "text-center", "py-3"], [3, "click"], [1, "modal"], [1, "modal-dialog"], [1, "modal-content"], [1, "modal-header"], [1, "btn-close", 3, "click"], [1, "modal-body"], ["class", "mb-3", 4, "ngIf"], [1, "mb-3"], ["type", "text", 1, "form-control", 3, "ngModelChange", "input", "ngModel"], [1, "form-select", 3, "ngModelChange", "ngModel"], [1, "form-control", 3, "ngModelChange", "input", "ngModel"], ["title", "C\xF3digo \xFAnico de identificaci\xF3n de la instituci\xF3n educativa (ej: 17H00160)", 1, "info-tooltip"], ["title", "Tipo de instituci\xF3n educativa (ej: ESCUELA, COLEGIO, INSTITUTO)", 1, "info-tooltip"], [1, "modal-footer"], [1, "btn", "btn-secondary", 3, "click"], [1, "btn", "btn-primary", 3, "click"], [1, "alert", "alert-danger"]], template: function InstitucionesComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h2");
        \u0275\u0275text(3, "Gesti\xF3n de Instituciones Educativas");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(4, "div", 2)(5, "button", 3);
        \u0275\u0275listener("click", function InstitucionesComponent_Template_button_click_5_listener() {
          return ctx.api.exportInstitucionesExcel();
        });
        \u0275\u0275text(6, "\u{1F4CA} Excel");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(7, "button", 4);
        \u0275\u0275listener("click", function InstitucionesComponent_Template_button_click_7_listener() {
          return ctx.api.exportInstitucionesPdf();
        });
        \u0275\u0275text(8, "\u{1F4C4} PDF");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(9, "button", 5);
        \u0275\u0275listener("click", function InstitucionesComponent_Template_button_click_9_listener() {
          return ctx.openModal();
        });
        \u0275\u0275elementStart(10, "span", 6);
        \u0275\u0275text(11, "+");
        \u0275\u0275elementEnd();
        \u0275\u0275text(12, " Nueva Instituci\xF3n ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(13, "div", 7)(14, "div", 8)(15, "label");
        \u0275\u0275text(16, "Parroquia:");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(17, "select", 9);
        \u0275\u0275twoWayListener("ngModelChange", function InstitucionesComponent_Template_select_ngModelChange_17_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.filterParroquiaId, $event) || (ctx.filterParroquiaId = $event);
          return $event;
        });
        \u0275\u0275listener("change", function InstitucionesComponent_Template_select_change_17_listener() {
          return ctx.filtrarPorParroquia();
        });
        \u0275\u0275elementStart(18, "option", 10);
        \u0275\u0275text(19, "Todas");
        \u0275\u0275elementEnd();
        \u0275\u0275template(20, InstitucionesComponent_option_20_Template, 2, 2, "option", 11);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(21, "div", 8)(22, "label");
        \u0275\u0275text(23, "Buscar:");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(24, "input", 12);
        \u0275\u0275twoWayListener("ngModelChange", function InstitucionesComponent_Template_input_ngModelChange_24_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.searchText, $event) || (ctx.searchText = $event);
          return $event;
        });
        \u0275\u0275listener("input", function InstitucionesComponent_Template_input_input_24_listener() {
        ...
        \u0275\u0275listener("click", function InstitucionesComponent_Template_th_click_30_listener() {
          return ctx.sort("nombre");
        });
        \u0275\u0275text(31);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(32, "th", 14);
        \u0275\u0275listener("click", function InstitucionesComponent_Template_th_click_32_listener() {
          return ctx.sort("parroquiaNombre");
        });
        \u0275\u0275text(33);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(34, "th", 14);
        \u0275\u0275listener("click", function InstitucionesComponent_Template_th_click_34_listener() {
          return ctx.sort("codigo");
        });
        \u0275\u0275text(35);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(36, "th", 14);
        \u0275\u0275listener("click", function InstitucionesComponent_Template_th_click_36_listener() {
        ...
        \u0275\u0275template(41, InstitucionesComponent_tr_41_Template, 16, 5, "tr", 15)(42, InstitucionesComponent_tr_42_Template, 3, 0, "tr", 16);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(43, "div", 17)(44, "div", 18);
        \u0275\u0275text(45);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(46, "div", 19)(47, "button", 20);
        \u0275\u0275listener("click", function InstitucionesComponent_Template_button_click_47_listener() {
          return ctx.goToPage(1);
        });
        \u0275\u0275text(48, "\xAB\xAB");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(49, "button", 20);
        \u0275\u0275listener("click", function InstitucionesComponent_Template_button_click_49_listener() {
          return ctx.prevPage();
        });
        \u0275\u0275text(50, "\xAB");
        \u0275\u0275elementEnd();
        \u0275\u0275template(51, InstitucionesComponent_span_51_Template, 3, 3, "span", 15);
        \u0275\u0275elementStart(52, "button", 20);
        \u0275\u0275listener("click", function InstitucionesComponent_Template_button_click_52_listener() {
          return ctx.nextPage();
        });
        \u0275\u0275text(53, "\xBB");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(54, "button", 20);
        \u0275\u0275listener("click", function InstitucionesComponent_Template_button_click_54_listener() {
        ...
        \u0275\u0275twoWayListener("ngModelChange", function InstitucionesComponent_Template_select_ngModelChange_59_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.pageSize, $event) || (ctx.pageSize = $event);
          return $event;
        });
        \u0275\u0275listener("change", function InstitucionesComponent_Template_select_change_59_listener() {
          return ctx.onPageSizeChange();
        });
        \u0275\u0275template(60, InstitucionesComponent_option_60_Template, 2, 2, "option", 11);
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(61, InstitucionesComponent_div_61_Template, 42, 9, "div", 23);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(17);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InstitucionesComponent, { className: "InstitucionesComponent", filePath: "app\\features\\admin\\pages\\instituciones\\instituciones.component.ts", lineNumber: 14 });
})();
export {
  InstitucionesComponent
};
//# sourceMappingURL=chunk-OCUZZZZE.js.map
